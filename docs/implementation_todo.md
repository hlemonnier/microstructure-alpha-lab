...
- [x] Add free/freemium paper-demo API source priority, executable Bybit/OKX demo fill fetchers, and raw-fill normalization for Bybit, OKX, Binance Spot Testnet, and Alpaca Paper exports.
