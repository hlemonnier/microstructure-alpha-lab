...
- True-L2 schema, replay validation, normalized tensor path, TCN/Transformer CPU smoke tests with optional holdout-manifest filtering, class weighting, early stopping, checkpoints, calibration metrics, prediction exports, stateful economic smoke fields, and a compact C++ L2 replay equivalence test.
...
```text
passed 256 direct test functions
```
